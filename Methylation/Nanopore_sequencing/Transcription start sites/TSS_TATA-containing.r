...
for (barcode in c("15", "17", "18")){
  print(barcode)
  data <- read.csv(paste0("barcode", barcode, "/barcode", barcode, "_EcoGII_TSS_TATA-containing_1kb_distance_combined.bedtools_closest", sep=""), header = FALSE, sep = "\t")
...
print(p)
ggsave("EcoGII_TSS_TATA-containing_methylation_counts.png", width = 8)
...
print(p)
ggsave("EcoGII_TSS_TATA-containing_methylation_counts_500bp.png", width = 8)
...
print(p)
ggsave("EcoGII_TSS_TATA-containing_methylation_above_70_combined.png", width = 8)
...
print(p)
ggsave("EcoGII_TSS_TATA-containing_methylation_above_70_combined_500bp.png", width = 8)
...
print(p)
ggsave("EcoGII_TSS_TATA-containing_methylation_above_70_combined_250bp.png", width = 8)
