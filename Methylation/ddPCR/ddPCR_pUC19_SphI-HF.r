...
ddPCR <- read.csv("ddPCR_pUC19_Rplot_011018.csv", header = TRUE)
print(ddPCR)
...
print(ddPCR_plot)
ggsave('ddPCR_T7107_pUC19_SphI-HF_011018.png', plot = ddPCR_plot, width = 14)
ggsave('ddPCR_T7107_pUC19_SphI-HF_011018.pdf', plot = ddPCR_plot)
